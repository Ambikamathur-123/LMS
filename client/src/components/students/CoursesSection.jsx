...
const CoursesSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <Link to={'/course-list'} onClick={()=>scrollTo(0, 0) }className="inline-block text-gray-800 border border-gray-500/30 px-10 py-3 rounded hover:bg-blue-500 mt-4 "> Show all courses</Link>
